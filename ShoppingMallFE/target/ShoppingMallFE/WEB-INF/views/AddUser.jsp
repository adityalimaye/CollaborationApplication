...
<body>
	<div class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="logout?${logoutUrl}"><span
	...
	<form:form action="saveuser" modelAttribute="userDetailsMall" enctype="multipart/form-data">
		...
		<table>
			<tr>
				...
				<td><form:input path="name" value="${userDetailsMallEdit.name}" required="true" /></td>
			</tr>
			...
			<tr>
				...
				<td><form:input path="email_id" value="${userDetailsMallEdit.email_id}" required="true" /></td>
			</tr>

			<tr>
				<td><form:label path="password" type="password">PASSWORD</form:label></td>
				<td><form:input path="password" type="password" value="${userDetailsMallEdit.password}" required="true" /></td>
			</tr>


			<tr>
				<td><form:label path="contact">MOBILE #:</form:label></td>
				<td><form:input path="contact" value="${userDetailsMallEdit.contact}" required="true" /></td>
			</tr>

			<tr>
				<td><form:label path="user_address">ADDRESS</form:label></td>
				<td><form:input path="user_address" value="${userDetailsMallEdit.user_address}" required="true" /></td>
			</tr>
			...
			<c:choose>
				...
				<c:otherwise>
					<tr>
						<td colspan="2"><button type="submit" value="Submit">SUBMIT</button> <button type="submit" value="Reset" onClick="this.form.reset()">Reset</button></td>
					</tr>
				</c:otherwise>
			</c:choose>
		</table>
	...
	<div align="center" class="container fluid"><a href="login">GO FOR LOGIN!</a></div>
	<br>
