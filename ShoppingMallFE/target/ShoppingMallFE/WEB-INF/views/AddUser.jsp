...
<body>
			...
			<table>
				...
				<tr>
					<c:choose>
						...
						<c:otherwise>
							<td><form:label path="id">USER_ID</form:label></td>
							<td><form:input path="id" placeholder="Enter the User_ID" required="true" /></td>						
						</c:otherwise>
					</c:choose>
	...
	<div align="center" class="container fluid">
		<a href="login"><span class="glyphicon glyphicon-user"> GO FOR LOGIN! </span></a>
	</div>
	<br>


<%-- 	<div align="center" style="color: #404040; font-size: 30px">VIEW USER DETAILS</div>
	<div align="center" class="container-fluid">
				...
				<tbody>
					<c:forEach items="${userDetailsMallList}" var="userDetailsMall">
						...
						<tr style="background-color: #C0C0C0; color: #1a1a1a; text-align: center;" height="30px">
							...
							<td><c:out value="${userDetailsMall.imagepath}"/></td>
