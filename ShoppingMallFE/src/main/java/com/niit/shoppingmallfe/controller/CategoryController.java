	   ...
	   return new ModelAndView("redirect:AddCategory");
		...
		@RequestMapping("/DeleteCat")
		 public ModelAndView DeleteCategory(@RequestParam String id) {
		  String categoryMallDelete= categoryMallDAO.deleteRow(id);
		  return new ModelAndView("redirect:AddCategory");
		 }
		
		
		@RequestMapping("/EditCat")
		public ModelAndView EditCategory(@RequestParam String id,@ModelAttribute("categoryMall") CategoryMall categoryMall){
			ModelAndView mv = new ModelAndView("AddCategory");
			List<CategoryMall> categoryMallList = categoryMallDAO.getList();
			mv.addObject("categoryMallList",categoryMallList);
