...
public class UserController {
	...
	public ModelAndView SaveUser(@ModelAttribute("userDetailsMall") UserDetailsMall userDetailsMall,@ModelAttribute("userDetailsMall1") UserDetailsMall userDetailsMall1 , BindingResult result, HttpServletRequest request, @RequestParam CommonsMultipartFile[] fileUpload)throws Exception {
		...
		mv1.addObject("userDetailsMall1", true);
		userDetailsMallDAO.save(userDetailsMall);
		userDetailsMallDAO.save(userDetailsMall1);
