...
public class SupplierController {
	...
	@RequestMapping("/DeleteSup")
	 public ModelAndView DeleteSupplier(@RequestParam String id) {
	  String supplierMallDelete= supplierMallDAO.deleteRow(id);
	  return new ModelAndView("redirect:AddSupplier");
	 }
	
	
	@RequestMapping("/EditSup")
	public ModelAndView EditSupplier(@RequestParam String id,@ModelAttribute("supplierMall") SupplierMall supplierMall){
		ModelAndView mv = new ModelAndView("AddSupplier");
		List<SupplierMall> supplierMallList = supplierMallDAO.getList();
		mv.addObject("supplierMallList",supplierMallList);
	...
	@RequestMapping("/Update_TravelAgent")
