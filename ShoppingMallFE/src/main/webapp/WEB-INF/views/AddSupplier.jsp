			...
			<table>
				...
				<tr>
					...
					<td><form:input path="address"
							value="${supplierMallEdit.address}" /></td>
				</tr>


				<tr>
					<td><form:label path="name">Name</form:label></td>
					<td><form:input path="name" value="${supplierMallEdit.name}" /></td>
				</tr>

				<tr>
					<td><form:label path="description">Description</form:label></td>
					<td><form:input path="description"
							value="${supplierMallEdit.description}" /></td>
				</tr>

				<tr>
					<td><form:label path="salary">Salary</form:label></td>
					<td><form:input path="salary"
							value="${supplierMallEdit.salary}" /></td>
				</tr>
					...
					<tbody>
						<c:forEach items="${supplierMallList}" var="supplierMall">
							...
							<tr style="background-color: #C0C0C0; color: #1a1a1a; text-align: center;"height="30px">
								...
								<td><c:out value="${supplierMall.name}" /></td>
								<td><c:out value="${supplierMall.description}" /></td>
								<td><c:out value="${supplierMall.salary}" /></td>
