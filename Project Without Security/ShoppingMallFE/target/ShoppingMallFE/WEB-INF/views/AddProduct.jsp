		...
		<div class="container-fluid">
			...
			<form:form action="saveproduct" modelAttribute="productMall"
				...
				<table>
					...
					<tr>
						<td><form:label path="cat_name">Cat_Name</form:label></td>
						<td><form:input path="cat_name" value="${productMallEdit.cat_name}" /></td>
					</tr>
					
					<tr>
						<td><form:label path="supp_name">Supp_Name</form:label></td>
						<td><form:input path="supp_name" value="${productMallEdit.supp_name}" /></td>
					</tr>
					...
					<c:choose>
						<c:when test="${!empty productMallEdit.id}">
							<tr>
								<td colspan="2"><button type="submit" value="Update_Product">Update_Product</button></td>
							</tr>
						</c:when>
						<c:otherwise>
							<tr>
						...
						<tbody>
							<c:forEach items="${productMallList}" var="productMall">
								...
								<tr class="active"
									...
									<td><c:out value="${productMall.cat_name}" /></td>
									<td><c:out value="${productMall.supp_name}" /></td>
